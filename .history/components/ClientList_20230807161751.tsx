...
function ClientList({ clients = [], selectAll, onToggleSelectAll }) {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 shadow-lg overflow-hidden rounded-lg">
      <table className="min-w-full divide-y divide-gray-300">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider flex items-center justify-start border-b border-gray-300">
              Notificar
              <input 
                type="checkbox" 
                id="checkAll" 
